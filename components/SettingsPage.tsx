...
export const SettingsPage = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* 글씨체 */}
      <TouchableOpacity
        style={[styles.sectionHeader, expandedSection === "font" && styles.sectionHeaderExpanded]}
        ...
        <View style={styles.sectionContent}>
          {fonts.map((font) => (
            ...
            >
              ...
              <Text style={[styles.optionText, font.style]}>{font.label}</Text>
            </TouchableOpacity>
          ))}
        </View>
      )}
        ...
        <View style={styles.sectionContent}>
          ...
          <View style={styles.toggleRow}>
            ...
            <TouchableOpacity onPress={() => toggleSwitch(setDailyAlarm, dailyAlarm)}>
              {dailyAlarm ? (
                <ToggledBtn width={50} height={28} />
              ) : (
                <UntoggledBtn width={50} height={28} />
              )}
            </TouchableOpacity>
          </View>
